  ...
  return (
    <>
      <Contener className="body-arranged-md">
        <Helmet>
          <title>
            Cennik | Nauki jazdy na nartach i snowboardzie - FigowSki
          </title>
          <meta
            name="description"
          ...
          <TextBox>
            ...
            <ul>
              ...
              <li>
                ...
                nauki i postępy w gronie rówieśników, na bardzo zbliżonym
            ...
            <p>
              ...
              Twoich potrzeb. Pakiety ustalane są indywidualnie – skontaktuj się
              z nami, aby omówić szczegóły i stworzyć program idealnie
